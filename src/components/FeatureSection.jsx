      ...
      <div className="flex flex-wrap justify-center mt-10 lg:mt-20 gap-6">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4">
            <div className="flex ">
              <div className="flex-shrink-0 mx-4 h-12 w-12 p-2 bg-neutral-900 text-orange-700 justify-center items-center rounded-full">
                {feature.icon}
              </div>
              <div >
             <h5 className="text-lg text-neutral-300">   {feature.text}</h5>
